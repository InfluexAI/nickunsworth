...
function MethodSection(){
  const steps = [
    {n:'01',t:'CLARIFY YOUR MESSAGE',d:"Find the through-line in your experience, expertise, story, and point of view—then shape it into a message your audience immediately understands."},
    {n:'02',t:'POSITION YOUR AUTHORITY',d:'Turn your message into an unmistakable point of difference, a personal brand, and a body of proof that makes the right people pay attention.'},
    {n:'03',t:'AMPLIFY YOUR REACH',d:'Use books, stages, media, podcasts, content, and strategic visibility to move your message beyond the people who already know you.'},
    {n:'04',t:'MONETIZE YOUR IMPACT',d:'Connect your authority to offers, a client journey, and a business model that allows you to be rewarded for the value you create.'},
    {n:'05',t:'LEAD THE MOVEMENT',d:'Build the confidence, community, and momentum to keep serving at a greater level—without losing the heart of why you started.'},
  ];
  return (
    <div className="section" style={{background:'var(--grad-ember-dark)',position:'relative',overflow:'hidden'}}>
      ...
      <div className="wrap section-in" style={{position:'relative'}}>
        <div style={{marginBottom:'var(--sp-64)',maxWidth:640}}>
          <h2 style={{fontFamily:'var(--font-display)',fontSize:'var(--fs-h2)',color:'var(--nu-white)',whiteSpace:'nowrap'}}>The Message-to-<span className="nu-gradient-text">Movement</span> Method</h2>
        </div>
        <div className="method-list">
          {steps.map((s,i)=>(
            <div key={i} className="method-row">
              ...
              <div>
                <div style={{fontFamily:'var(--font-title)',fontWeight:700,fontSize:'var(--fs-h4)',letterSpacing:'.08em',color:'var(--nu-white)',marginBottom:'var(--sp-12)'}}>{s.t}</div>
